...
{     public class GuildPlayerRankUpdateActivity : GuildLogbookEntryBasicInformation  
    {         public new const ushort Id = 222;
        ...
        public GuildPlayerRankUpdateActivity(GuildRankMinimalInformation guildRankMinimalInfos,long sourcePlayerId,long targetPlayerId,string sourcePlayerName,string targetPlayerName,int id,double date)
        {
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            if (sourcePlayerId < 0 || sourcePlayerId > 9.00719925474099E+15)
            {
            ...
            if (targetPlayerId < 0 || targetPlayerId > 9.00719925474099E+15)
            {
