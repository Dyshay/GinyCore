...
{     public class AlterationInfo  
    {         public const ushort Id = 5142;
        ...
        public virtual void Serialize(IDataWriter writer)
        {
            ...
            if (creationTime < -9.00719925474099E+15 || creationTime > 9.00719925474099E+15)
            {
            ...
            if (expirationValue < -9.00719925474099E+15 || expirationValue > 9.00719925474099E+15)
            {
