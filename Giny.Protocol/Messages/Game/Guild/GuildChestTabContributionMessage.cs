...
{     public class GuildChestTabContributionMessage : NetworkMessage  
    {         public  const ushort Id = 8798;
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            if (requiredAmount < 0 || requiredAmount > 9.00719925474099E+15)
            {
            ...
            if (currentAmount < 0 || currentAmount > 9.00719925474099E+15)
            {
                throw new System.Exception("Forbidden value (" + currentAmount + ") on element currentAmount.");
            }

            writer.WriteVarLong((long)currentAmount);
            if (chestContributionEnrollmentDelay < 0 || chestContributionEnrollmentDelay > 9.00719925474099E+15)
            {
            ...
            if (chestContributionDelay < 0 || chestContributionDelay > 9.00719925474099E+15)
            {
